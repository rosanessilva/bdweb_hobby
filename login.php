...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["senha"]))){
        $senha_err = "Please enter your password.";
    } else{
    ...
    if(empty($email_err) && empty($senha_err)){
        ...
        $sql = "SELECT id, email, senha FROM infos WHERE email = ?";        
        $pass = "SELECT senha FROM infos WHERE email = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $email, $va_senha);
